...
vlib work
vcom -explicit  -93 "Circuito_Convert.vhd"
vcom -explicit  -93 "tb_Circuito_Convert.vhd"
vsim -t 1ns -lib work tb_Circuito_Convert -do "add wave -radix unsigned sim:/tb_Circuito_Convert/*" -do "view wave" -do "view structure" -do "view signals" -do "run 60ns" -do "wave zoom full"